...
<body onload="Chose(document.getElementById('Dropdownlist1'));Chose( document.getElementById('Dropdownlist2'));" style="background-image:url(330282.jpg);">
  <div id="all">
     <div id="header">
     ...
     <div id="main">
	    <form action="index.php" method="post" style="font-family:幼圆">
           ...
           <select name="Dropdownlist_gx1" id="Dropdownlist_gx1" style="width:100px;" class="f">
            ...
            <input name="TextBox1" type="text" id="TextBox1" style="width:150px; line-height:25px;" / class="f">
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST' ){
			if (isset($_POST['TextBox1'])){
				...
				if (empty($chose2))
					...
					$q2 = "$chose2 like '%{$_POST['TextBox2']}%'";
				if (empty($chose1))
					$q1 = ' 1 = 1 ';
				else
					$q1 = "$chose1 like '%{$_POST['TextBox1']}%'";
